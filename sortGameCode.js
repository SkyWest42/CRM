...
var arrStrResponses = [
    ...
    'מלש"ב/ית יקר/ה, בקשתך להקדמת גיוס לא אושרה לאור צורכי צבא, צו הגיוס שבידך הינו בתוקף. בהצלחה!',
    'מלש"ב/ית יקר/ה, לאחרונה התקבלה פנייתך בנוגע לבקשת מיון כלל חמן בחיל המודיעין, הרינו להודיע לך שבנקודה זו תמו המיונים למחזור גיוסך ולכן לא נוכל להיענות לבקשתך. אנו בטוחים כי תוכל לממש את כישוריך בכלל המסלולים אותם מציע צה"ל.',
