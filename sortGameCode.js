...
var arrStrResponses = [
    ...
    'מלש"ב/ית יקר/ה, בקשתך לשינוי מועד גיוסך התקבלה במערכת ונבחנה על ידי הגורמים הרלוונטיים במיטב. לצערנו לא ניתן לאשר את בקשתך לאור גילך הצעיר/מבוגר יחסית לעומת שאר המתגייסים בעונת הגיוס המבוקשת. צו הגיוס שבידך הינו בתוקף. אנו מאחלים לך גיוס מוצלח!',
