...
var matinstructionsVideos = [["read", "1) קוראים את החומר"], ["do", "2) מבצעים את ההוראות"], ["navigate", "3) ניתן לנווט בין פרקים"], ["adjust", "4) ניתן להנגיש כרצונכם"]];
...
var matContent = [
    ...
    [
        [
            ...
            {
                "section": "<p>לחיצה על השדה \"ערוץ הפניה\" תפתח רשימת ערוצים אפשריים. מהרשימה ניתן לבחור את הערוץ הרלוונטי בלחיצת כפתור.</p><p>רוב הפניות נפתחות אוטומטית כאשר מתקבל מייל או טלפון. כאשר פותחים פניה ידנית, מדובר בדרך כלל: <br> - בפניה יזומה של מיטב למלש\"ב בערוץ \"פניה טלפונית\" (לדוגמא לשם זימון לוועדה או ראיון) <br> - ב\"פניה פיזית\", עבור מלש\"ב שהתייצב וטופל בלשכה <br>- או בערוצי פניה \"פסטיבל מתגייסים\" ו\"יום פתוח\", הקשורים לאירועים וכנסים שנתיים.</p>",
        ...
        [
            ...
            },
            {
                ...
                "instruction": "העתק את הטקסט הבא לתוך תיאור הטיפול בפניה: <strong title='לחץ כדי להעתיק' onmouseover=\"selectText()\" onclick='copyText()' id='to-copy' class='to-copy'>050-1234567 הנל התייצב בלשכה וביקש לשנות את מקום הגיוס שלו? בדקתי את פרטיו ואישרתי לו שינוי נקודת הגיוס מתל השומר לגבעת התחמושת.</strong>",
                "interactionType": "type",
                "correctInput": "050-1234567 הנל התייצב בלשכה וביקש לשנות את מקום הגיוס שלו? בדקתי את פרטיו ואישרתי לו שינוי נקודת הגיוס מתל השומר לגבעת התחמושת.",
                "width": "45%",
                "height": "10%",
                "right": "49%",
                "top": "76%",
    ...
    [
        [
            {
                "section": "<p>לאחר שנתנו תשובה סופית לפניה, והיא <strong>אינה דורשת טיפול נוסף </strong>מאף גורם, <strong>חשוב מאוד שנזכור לסגור את הפניה</strong>. במקרה בו <em>נשמור</em> ולא נדאג <em>לסגור</em> את הפניה, המלש\"ב לא יקבל מענה ולא ידע כי פנייתו טופלה.</p><p>נתחיל מהתצוגה הראשית של המשתמש שלנו.</p><hr><p>נבחר פניה לסגירה וניכנס לתוכה.</p>",
